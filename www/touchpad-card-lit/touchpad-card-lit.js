...
execute(i){
  ...
  if(context.call_data.key_data != undefined)
    if(i == 8)
      this.hass.callService(buttons.call_data.domain,context.call_data.service,{media_content_id: 'KEY_ENTER', media_content_type: context.call_data.key_data.media_content_type},{entity_id: this.config.entity});
    else if(i == 9)
